...
namespace PrehistoricPlatformer.UI
{
    public class CloudSpawner : MonoBehaviour
    {
        ...
        [SerializeField]
        private float cloudMinSpeed = 50 , cloudMaxSpeed=70;
        [SerializeField]
        ...
        private void SpawnClouds()
        {
            ...
            newCloud.Speed = Random.Range(cloudMinSpeed,cloudMaxSpeed);
        ...
        private Vector3 GetRandomPosition()
        {
            return new Vector3(
                ...
                Random.Range(transform.position.y - length / 2 * canvas.scaleFactor, 
                    transform.position.y + length / 2 * canvas.scaleFactor), 1);
        }
